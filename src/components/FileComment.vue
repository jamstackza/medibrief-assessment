<template lang="html">
    <sui-comment-group>
        ...
        <sui-comment>
            <sui-comment-avatar src="/images/matt.jpg" />
            <sui-comment-content>
        ...
        <sui-comment>
            <sui-comment-avatar src="/images/elliot.jpg" />
            <sui-comment-content>
            ...
            <sui-comment-group>
                <sui-comment>
                    <sui-comment-avatar src="/images/jenny.jpg" />
                    <sui-comment-content>
        ...
        <sui-comment>
            <sui-comment-avatar src="/images/joe.jpg" />
            <sui-comment-content>
